...
export default async function WorkloadPage() {
  ...
  // Solo admin e manager vedono il workload globale dalla dashboard.
  if (!isAdmin && !isManager) redirect('/dashboard')

  const data = await fetchWorkloadData(sb, user.id, null)
  ...
  return (
    <WorkloadClient
      ...
      title="Workload"
      subtitle="Progetti in parallelo, effort e timeline di tutto il team"
    />
  )
}
