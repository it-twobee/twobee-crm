...
export type BridgeMonth = {
  ...
  costsVatPaid: number
  /** quello che il piano compensi destina ai soci e ai commerciali */
  distributed: number
...
export function cashBridge(
  ...
  const items = [
    ...
    { label: 'Compensi maturati e non pagati', amount: r2(distributed - partnersOut),
      why: 'Il piano li destina, la banca vede solo quelli usciti. La differenza è quello che i soci e i commerciali devono ancora ricevere.' },
