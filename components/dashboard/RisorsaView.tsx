      ...
      <div className="glass rounded-2xl p-5">
        ...
        {tasksToday.length === 0 ? (
          <div className="text-center py-6">
            ...
            <p className="text-[10px] text-overlay/30 mt-1">Goditi la giornata!</p>
          </div>
        ) : (
          <div className="space-y-1.5">
            {tasksToday.map(t => (
              <Link key={t.id} href="/le-mie-attivita"
                ...
                <ChevronRight className="w-3.5 h-3.5 text-overlay/20 group-hover:text-gold shrink-0" />
              </Link>
            ))}
          </div>
        )}
      ...
      <div className="glass rounded-2xl p-5">
        ...
        {tasksDueSoon.length === 0 ? (
          <div className="text-center py-6">
            ...
            <p className="text-[10px] text-overlay/30 mt-1">Nessun task in scadenza nei prossimi 7 giorni</p>
          </div>
        ) : (
          <div className="space-y-1.5">
              ...
              return (
                <Link key={t.id} href="/le-mie-attivita"
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {t.project?.name && (
                      <p className="text-[10px] text-overlay/30 truncate">{t.project.name}</p>
                    )}
                  </div>
                  {dl && (
      ...
      <div className="glass rounded-2xl p-5">
        ...
        {activeChannels.length === 0 ? (
          <div className="text-center py-6">
            ...
            <p className="text-[10px] text-overlay/30 mt-1">Non sei membro di nessun canale chat</p>
          </div>
        ) : (
          <div className="space-y-1.5">
            {activeChannels.slice(0, 6).map(ch => (
              <Link key={ch.id} href="/chat"
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {ch.lastMessage && (
                    <p className="text-[10px] text-overlay/30 truncate">
                ...
                {ch.lastMessageTime && (
                  <span className="text-[9px] text-overlay/20 shrink-0">
